...
// Full 54-column schema matching backend target-table-schemas.ts
const mockCoreSchema: TargetTableSchemaResponse = {
  ...
  columns: [
    ...
    { name: 'source_customer_no', type: 'VARCHAR(20)', nullable: false, isPrimaryKey: false, isEtlTracking: false, description: '來源客戶編號' },
    { name: 'customer_type', type: 'VARCHAR(2)', nullable: false, isPrimaryKey: false, isEtlTracking: false, description: '客戶類型' },
    { name: 'name', type: 'VARCHAR(100)', nullable: false, isPrimaryKey: false, isEtlTracking: false, description: '姓名' },
    ...
    { name: 'company_scale', type: 'VARCHAR(1)', nullable: true, isPrimaryKey: false, isEtlTracking: false, description: '公司規模' },
    // F. 財務與風控 (10)
    ...
    { name: 'fine_flag', type: 'CHAR(1)', nullable: true, isPrimaryKey: false, isEtlTracking: false, description: '違規欠稅旗標' },
    ...
    { name: 'data_source', type: 'VARCHAR(50)', nullable: false, isPrimaryKey: false, isEtlTracking: true, description: '資料來源識別' },
    { name: '_etl_loaded_at', type: 'TIMESTAMP', nullable: false, isPrimaryKey: false, isEtlTracking: true, description: 'ETL 載入時間' },
    { name: '_etl_pipeline_id', type: 'UUID', nullable: false, isPrimaryKey: false, isEtlTracking: true, description: 'Pipeline ID' },
  ],
};
