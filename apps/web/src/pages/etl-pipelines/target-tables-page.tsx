    ...
    <div className="flex min-h-screen bg-[#F9FAFB]">
      ...
      <aside className="w-56 bg-white border-r border-gray-200 flex flex-col shrink-0">
        <div className="px-5 py-5 border-b border-gray-200">
          <h1 className="text-xl font-bold text-[#2563EB] tracking-wide">CDMP</h1>
        ...
        <nav className="flex-1 py-3">
          ...
          <a
            href="/etl-pipelines"
            className="flex items-center gap-3 px-5 py-2.5 text-sm text-[#2563EB] bg-blue-50 border-l-[3px] border-[#2563EB] font-medium"
            aria-current="page"
          >
            <Workflow size={20} />
            ETL Pipeline
