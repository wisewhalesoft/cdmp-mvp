...
import { Users, Database, ArrowDownToLine, ChevronRight, CalendarClock, Workflow, Contact, } from 'lucide-react';
import {
    ...
    <div className="flex min-h-screen bg-[#F9FAFB]">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-14 bg-white border-b border-[#E5E7EB] flex items-center justify-between px-6 shrink-0">
          <h1 className="text-base font-semibold text-gray-800">新增擷取任務</h1>
