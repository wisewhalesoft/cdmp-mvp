export const ERROR_CODES = {
  ...
  /** 外部庫拒絕 UPDATE（SQL Server 229/230：物件/資料行權限被拒）→ 422，非 500。 */
  WRITEBACK_PERMISSION_DENIED: 'WRITEBACK_PERMISSION_DENIED',
  /** 其他外部寫入錯誤（逾時、欄位長度、死結…）→ 422 並帶原始驅動訊息，避免無資訊 500。 */
  WRITEBACK_EXTERNAL_WRITE_FAILED: 'WRITEBACK_EXTERNAL_WRITE_FAILED',
...
export const ERROR_MESSAGES = {
  ...
  WRITEBACK_EXTERNAL_WRITE_FAILED: '回寫電銷系統時發生錯誤，本批未完成寫入',
