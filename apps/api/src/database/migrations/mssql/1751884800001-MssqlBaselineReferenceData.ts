 ...
 * 灌入後筆數：roles 2 / pooldata_field_whitelist 19 / pooldata_field_option 454
 *   （以 dev CDMP 為 ground truth；2026-07 已硬刪除 brand_no/list_type/sta_code_na。baseline 與 data-seed 之
