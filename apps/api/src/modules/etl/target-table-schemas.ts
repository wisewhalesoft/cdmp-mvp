 ...
 * Phase 1 MVP: 僅 customer_core 一個目標表（85 欄位，A~H 八分類）
...
export const TARGET_TABLE_SCHEMAS: TargetTableSchema[] = [
  {
    ...
    columns: [
      ...
      { name: 'customer_type_code', type: 'VARCHAR(2)', nullable: false, isPrimaryKey: false, isEtlTracking: false, category: 'A', description: '客戶類型代碼（01=個人/02=企業/04=外籍）' },
      { name: 'customer_type_desc', type: 'VARCHAR(50)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'A', description: '客戶類型描述' },
      ...
      { name: 'marital_status_code', type: 'VARCHAR(1)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'B', description: '婚姻狀態代碼' },
      { name: 'marital_status_desc', type: 'VARCHAR(50)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'B', description: '婚姻狀態描述' },
      ...
      // C. 聯絡資訊 (10)
      { name: 'mobile_phone', type: 'VARCHAR(30)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'C', description: '行動電話' },
      { name: 'home_phone', type: 'VARCHAR(30)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'C', description: '戶籍電話' },
      { name: 'contact_phone', type: 'VARCHAR(30)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'C', description: '通訊電話' },
      { name: 'office_phone', type: 'VARCHAR(30)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'C', description: '公司電話' },
      { name: 'registered_phone', type: 'VARCHAR(30)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'C', description: '公司登記電話' },
      { name: 'registered_fax', type: 'VARCHAR(30)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'C', description: '公司傳真' },
      { name: 'business_fax', type: 'VARCHAR(30)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'C', description: '營業傳真' },
      { name: 'business_mobile', type: 'VARCHAR(30)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'C', description: '營業行動電話' },
      ...
      { name: 'role', type: 'VARCHAR(50)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'E', description: '客戶角色' },
      ...
      { name: 'job_level_code', type: 'VARCHAR(2)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'E', description: '職級代碼' },
      { name: 'job_level_desc', type: 'VARCHAR(50)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'E', description: '職級描述' },
      { name: 'industry_code', type: 'VARCHAR(10)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'E', description: '行業代碼' },
      ...
      // F. 財務與風控 (12)
      { name: 'monthly_income_code', type: 'VARCHAR(5)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'F', description: '月所得代碼' },
      { name: 'monthly_income_desc', type: 'VARCHAR(50)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'F', description: '月所得描述' },
      { name: 'approved_income', type: 'INTEGER', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'F', description: '認定月收入' },
      { name: 'income_source_code', type: 'VARCHAR(5)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'F', description: '收入來源代碼' },
      { name: 'income_source_desc', type: 'VARCHAR(50)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'F', description: '收入來源描述' },
      ...
      { name: 'employee_count_code', type: 'VARCHAR(6)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'G', description: '員工人數代碼' },
      { name: 'employee_count_desc', type: 'VARCHAR(50)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'G', description: '員工人數描述' },
      { name: 'is_listed_code', type: 'VARCHAR(6)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'G', description: '上市櫃代碼' },
      { name: 'is_listed_desc', type: 'VARCHAR(50)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'G', description: '上市櫃描述' },
      { name: 'business_item', type: 'VARCHAR(100)', nullable: true, isPrimaryKey: false, isEtlTracking: false, category: 'G', description: '營業項目' },
