...
> **測試文件總數**：81 份（4 策略文件 + 68 Feature 測試文件 + F039 策略文件 1 份 + F040/F041 測試文件 2 份 + 整合測試 2 份 + Migration 測試 1 份 + Regression Guard 1 份 + F109 test 1 份 + **Infrastructure test 1 份**）
> **總測試場景數**：2008 個（前 1978 + **AD-E07-38 P1a MSSQL 遷移最小可連線＋登入 +30**：CONN 6 + TYPE 7 + LOGIN 3 + CRUD 7 + CASE 3 + REG 3 + HELPER 1，合計 2008）
>
