...
> **測試文件總數**：89 份（4 策略文件 + 68 Feature 測試文件 + F039 策略文件 1 份 + F040/F041 測試文件 2 份 + 整合測試 2 份 + Migration 測試 1 份 + Regression Guard 1 份 + F109 test 1 份 + **Infrastructure test 9 份**）
> **總測試場景數**：2416 個（前 2320 + **AD-E07-41 MSSQL 全面遷移 P4a（ETL Handler 群組一：extract/field_mapping/derived_field/type_cast/conditional，P4 首片）+96**：QUOTE 3 + HELPER 11 + CLEANUP 6 + DISPATCH 3 + EXTRACT 14 + FIELDMAP 10 + DERIVED 16 + CAST 17 + COND 7 + REG 5 + STATIC 4，合計 2416）
>
