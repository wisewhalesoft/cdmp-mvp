...
> **測試文件總數**：90 份（4 策略文件 + 68 Feature 測試文件 + F039 策略文件 1 份 + F040/F041 測試文件 2 份 + 整合測試 2 份 + Migration 測試 1 份 + Regression Guard 1 份 + F109 test 1 份 + **Infrastructure test 10 份**）
> **總測試場景數**：2482 個（前 2416 + **AD-E07-41 MSSQL 全面遷移 P4b（ETL Handler 群組二：merge/lookup，含 UPDATE...FROM 重構，P4 第二片）+66**：ALTERCOL 8 + UPDATEFROM 10 + CLEANUP 4 + DISPATCH 2 + MERGE 15 + RESOLVE 3 + SKIP 5 + DEFAULT 2 + LOOKUP 8 + REG 5 + STATIC 4，合計 2482）
>
...
| **Infrastructure 小計** | | | **10 files** | **504** | |
| **總合計** | | | **84 files** | **2414** | |
