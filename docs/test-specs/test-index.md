...
> **測試文件總數**：84 份（4 策略文件 + 68 Feature 測試文件 + F039 策略文件 1 份 + F040/F041 測試文件 2 份 + 整合測試 2 份 + Migration 測試 1 份 + Regression Guard 1 份 + F109 test 1 份 + **Infrastructure test 4 份**）
> **總測試場景數**：2144 個（前 2090 + **AD-E07-39 P1b3 Bootstrap/Seed 三支腳本改寫 + B2 npm alias 修復驗證 +54**：DIALECT 4 + ALIAS 6 + SITE 12 + BOOT 5 + COUNT 12 + IDEM 5 + REG 5 + PROBE 2 + STATIC 3，合計 2144）
>
