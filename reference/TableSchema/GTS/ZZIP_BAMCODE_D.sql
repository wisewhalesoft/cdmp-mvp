...
/****** Object:  Table [dbo].[ZZIP_BAMCODE_D]    Script Date: 2026/4/20 下午 02:43:07 ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [dbo].[ZZIP_BAMCODE_D] ADD  CONSTRAINT [DF_ZZIP_BAMCODE_D_IS_VALID]  DEFAULT ('Y') FOR [IS_VALID]
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'是否有效' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'ZZIP_BAMCODE_D', @level2type=N'COLUMN',@level2name=N'IS_VALID'
GO
